export const config = {
  listName: "Settings: Set position spring from duration",
  displayText: "Set position spring \"{0}\" settings from duration {1}s, precision {2}, bounce profile {3}",
  description: "Compute stiffness and damping so a position spring settles in about the requested duration, with a selectable bounce profile.",
  params: [
...
export default function (springId, duration, precision, bounceProfile) {
  this._setTransformSpringSettingsFromDurationId(0, springId, duration, precision, bounceProfile);
}